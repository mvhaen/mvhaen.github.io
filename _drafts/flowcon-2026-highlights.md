...
That also means AI is not just another product category we can shop for and install. If anything, it's a moving design space that forces us to think more carefully about context, learning, and judgement.
...
What made this feel so relevant to me is that AI is increasing the pace. It is pushing us to make room again, which means we also need to revisit past decisions about what we build for ourselves and what we don't. Maybe some of those conversations would have happened anyway, but AI is making them more urgent. It might sound technical at first, but Product Managers and Product Owners need to be aware of this too if they want to keep their products healthy and make sure time investments go to the right things.
...
I think it's fun to see someone start from older literature like the threat-rigidity effect and tie it back to these times. It also reminded me of a longer essay that I've been working on for a while, and then kind of got sidetracked on.

But what was probably most striking to me was not just the theory. It was the responses to some of the questions Andrea asked the audience. The symptoms people brought up were telling: burnout, disengagement, demotivation, silent quitting, silos, politics, lack of transparency, fear, lack of autonomy. It shows that the pains we feel when leaders focus only on short-term decisions are broadly shared across the industry.
...
It was also good to see Matthew Philip and Daniel Vacanti point to our ongoing flaws in how we deal with backlogs and prioritization.

That topic never really goes away, does it? We still overload backlogs, confuse optionality with commitment, and often treat prioritization as a static ranking exercise instead of an economic and learning problem. So I was glad to hear that challenged again.

There's probably a useful closing section here around the difference between having more items, having better decisions, and actually creating flow.

TODO:
- Add the specific point from Matthew Philip's talk that I want to keep.
- Add the specific point from Daniel Vacanti's talk that I want to keep.
- Decide whether to include work item size here too, or keep that separate.
- Turn this into a practical closing reflection instead of just conference notes.

### What stayed with me

This is the thread I keep seeing:

- AI is not a commodity decision. It's a context and practice problem.
- Wardley Maps help make strategic discussion concrete.
- Good architecture comes from continuous discussion, not isolated design authority.
- Leadership matters because it shapes whether those discussions can happen at all.
- Backlogs and prioritization still reveal how poorly many organizations think about flow.
